...
//
            let piece1 = Piece(indexes: Indexes(x: 6, y: 1), colors: [UIColor.red, UIColor.cyan], version: 3, isLocked: false, doesPivot: false)
            board.pieces.append(piece1)



            let piece2 = Piece(indexes: Indexes(x: 7, y: 1), colors: [UIColor.cyan, UIColor.red], version: 4, isLocked: false, doesPivot: false)
            board.pieces.append(piece2)

            let piece3 = Piece(indexes: Indexes(x: 7, y: 2), colors: [UIColor.red, UIColor.cyan], version: 1, isLocked: false, doesPivot: false)
            board.pieces.append(piece3)
            ...
            let piece4 = Piece(indexes: Indexes(x: 5, y: 2), colors: [UIColor.red, UIColor.cyan], version: 3, isLocked: false, doesPivot: false)
            board.pieces.append(piece4)



            let piece5 = Piece(indexes: Indexes(x: 5, y: 3), colors: [UIColor.cyan, UIColor.red], version: 4, isLocked: false, doesPivot: false)
            board.pieces.append(piece5)

            let piece6 = Piece(indexes: Indexes(x: 6, y: 3), colors: [UIColor.red, UIColor.cyan], version: 1, isLocked: false, doesPivot: false)
            board.pieces.append(piece6)

            let piece7 = Piece(indexes: Indexes(x: 6, y: 4), colors: [UIColor.red, UIColor.cyan], version: 1, isLocked: false, doesPivot: false)
            board.pieces.append(piece7)
            ...
            let piece8 = Piece(indexes: Indexes(x: 3, y: 3), colors: [UIColor.cyan, UIColor.red], version: 4, isLocked: false, doesPivot: false)
            board.pieces.append(piece8)

            let piece9 = Piece(indexes: Indexes(x: 3, y: 2), colors: [UIColor.red, UIColor.cyan], version: 1, isLocked: false, doesPivot: false)
            board.pieces.append(piece9)

            let piece10 = Piece(indexes: Indexes(x: 2, y: 3), colors: [UIColor.red, UIColor.cyan], version: 1, isLocked: false, doesPivot: false)
            board.pieces.append(piece10)

            let piece11 = Piece(indexes: Indexes(x: 2, y: 2), colors: [UIColor.red, UIColor.cyan], version: 1, isLocked: false, doesPivot: false)
...
//            board.pieces.append(piece14)
            ...
            let piece12 = Piece(indexes: Indexes(x: 8, y: 0), colors: [UIColor.cyan, UIColor.red], version: 4, isLocked: false, doesPivot: false)
            board.pieces.append(piece12)

            let piece13 = Piece(indexes: Indexes(x: 8, y: 1), colors: [UIColor.red, UIColor.cyan], version: 1, isLocked: false, doesPivot: false)
            board.pieces.append(piece13)

            let piece14 = Piece(indexes: Indexes(x: 8, y: 2), colors: [UIColor.red, UIColor.cyan], version: 1, isLocked: false, doesPivot: false)
            board.pieces.append(piece14)

            let piece15 = Piece(indexes: Indexes(x: 8, y: 3), colors: [UIColor.red, UIColor.cyan], version: 1, isLocked: false, doesPivot: false)
            ...
            let piece16 = Piece(indexes: Indexes(x: 6, y: 8), colors: [UIColor.cyan, UIColor.red], version: 4, isLocked: false, doesPivot: false)
            board.pieces.append(piece16)

            let piece17 = Piece(indexes: Indexes(x: 7, y: 8), colors: [UIColor.red, UIColor.cyan], version: 1, isLocked: false, doesPivot: false)
            board.pieces.append(piece17)

            let piece18 = Piece(indexes: Indexes(x: 8, y: 8), colors: [UIColor.red, UIColor.cyan], version: 1, isLocked: false, doesPivot: false)
            board.pieces.append(piece18)

            let piece19 = Piece(indexes: Indexes(x: 7, y: 7), colors: [UIColor.red, UIColor.cyan], version: 1, isLocked: false, doesPivot: false)
            ...
            let piece20 = Piece(indexes: Indexes(x: 6, y: 6), colors: [UIColor.red, UIColor.cyan], version: 1, isLocked: false, doesPivot: false)
            board.pieces.append(piece20)

            let piece21 = Piece(indexes: Indexes(x: 6, y: 5), colors: [UIColor.red, UIColor.cyan], version: 1, isLocked: false, doesPivot: false)
            ...
            let piece22 = Piece(indexes: Indexes(x: 1, y: 6), colors: [UIColor.red, UIColor.cyan], version: 1, isLocked: false, doesPivot: false)
            board.pieces.append(piece22)

            let piece23 = Piece(indexes: Indexes(x: 2, y: 6), colors: [UIColor.red, UIColor.cyan], version: 1, isLocked: false, doesPivot: false)
            board.pieces.append(piece23)


            let piece24 = Piece(indexes: Indexes(x: 2, y: 7), colors: [UIColor.red, UIColor.cyan], version: 1, isLocked: false, doesPivot: false)
            board.pieces.append(piece24)

            let piece25 = Piece(indexes: Indexes(x: 3, y: 7), colors: [UIColor.red, UIColor.cyan], version: 1, isLocked: false, doesPivot: false)
            board.pieces.append(piece25)

            let piece26 = Piece(indexes: Indexes(x: 3, y: 8), colors: [UIColor.red, UIColor.cyan], version: 1, isLocked: false, doesPivot: false)
            board.pieces.append(piece26)

            let group7 = Group(pieces: [piece22, piece23, piece24, piece25, piece26])

            let piece27 = Piece(indexes: Indexes(x: 4, y: 6), colors: [UIColor.red, UIColor.cyan], version: 1, isLocked: false, doesPivot: false)
            board.pieces.append(piece27)

            let group8 = Group(pieces: [piece27])


            let piece28 = Piece(indexes: Indexes(x: 0, y: 0), colors: [UIColor.red, UIColor.cyan], version: 1, isLocked: false, doesPivot: false)
            board.pieces.append(piece28)

            let piece29 = Piece(indexes: Indexes(x: 0, y: 1), colors: [UIColor.red, UIColor.cyan], version: 1, isLocked: false, doesPivot: false)
